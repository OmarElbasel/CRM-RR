...
class SocialChannel(models.Model):
    ...
    # Fernet-encrypted access token (Constitution: encrypted at rest)
    access_token = models.BinaryField()
    tiktok_open_id = models.CharField(max_length=255, null=True, blank=True)
...
class Message(models.Model):
    ...
    # Deduplication key — unique within a platform (TikTok format: "{video_id}:{comment_id}")
