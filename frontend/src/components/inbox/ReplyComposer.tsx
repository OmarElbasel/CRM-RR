...
export function ReplyComposer({ messageId, aiDraft, aiDraftAr, disabled, onReplySent }: ReplyComposerProps) {
  ...
  return (
    <section className="bg-white border-t border-ds-line-2 p-6 z-40">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          {aiDraftAr && (
            <button 
              ...
              className="text-left p-4 border border-ds-primary/15-dim bg-primary-container/10 rounded-xl hover:bg-primary-container/20 transition-all group flex flex-col justify-between"
            >
              <div>
        ...
        <div className="relative">
          ...
          <div className="flex items-center gap-2 bg-paper border border-ds-line-2 rounded-2xl p-2 pl-4 shadow-sm focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/10 transition-all">
            ...
            <input 
              ...
              className="flex-1 bg-transparent border-none focus:ring-0 text-sm py-2 placeholder:text-ds-line" 
